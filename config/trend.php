...
return [
    ...
    'sources' => [
        ...
        ['key' => 'x_trends', 'name' => 'X API — Trends', 'kind' => 'api', 'geo' => 'GLOBAL', 'enabled' => false, 'cost_note' => 'parked: every useful surface is either algorithmic (personalized trends), paid per post ($0.005), or names-only. Topic feeds have no API. Revisit only if X exposes topic feeds or the owner funds roughly $3/month', 'docs_url' => 'https://docs.x.com/x-api/trends/introduction'],
