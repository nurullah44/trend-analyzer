...
return [
    ...
    'sources' => [
        ...
        ['key' => 'x_trends', 'name' => 'X API — Trends', 'kind' => 'api', 'geo' => 'GLOBAL', 'enabled' => true, 'cost_note' => 'user-context personalized trends: post_count + trending_since, personalised to the owner; price unpublished, check console. Public trends are $0.010/request but names-only', 'docs_url' => 'https://docs.x.com/x-api/trends/get-trends-by-woeid'],
