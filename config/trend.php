...
return [
    ...
    'sources' => [
        ...
        ['key' => 'x_trends', 'name' => 'X API — Trends', 'kind' => 'api', 'geo' => 'GLOBAL', 'enabled' => true, 'cost_note' => 'pay-per-use, $0.010 per request — about $0.30 a month at one request a day; returns ranked names only, no volumes', 'docs_url' => 'https://docs.x.com/x-api/trends/get-trends-by-woeid'],
